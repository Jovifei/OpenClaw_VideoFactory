...
`topic_only_v1` 是当前的补充验收范围：Flash/watchdog、FreeRTOS、I2C 和一条
...
- 所有来源 SHA 匹配。
- 当前 acceptance scope 所需主题 fixture、live topic（仅 `topic_only_v1`）、
  实际提供的 reference job、lifecycle 与 boundary audit 全部通过。
