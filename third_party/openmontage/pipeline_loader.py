# Source: https://github.com/calesthio/OpenMontage/blob/cd9f3c1f03368be87b140af494914b8ee4e3c7a4/lib/pipeline_loader.py
# Modified: manifest and schema paths are scoped to this vendored package.
...
PIPELINE_DEFS_DIR = Path(__file__).resolve().parent / "pipelines"
SCHEMA_PATH = (
